...
const communityLogos: LogoItem[] = [
  ...
  { src: '/logos/shenicest.png', alt: 'SHE NICEST', title: 'SHE NICEST', width: 637, height: 120 },
  { src: '/logos/infinisynapse.png', alt: 'InfiniSynapse', title: 'InfiniSynapse', width: 189, height: 120 },
];
